        ...
        if (!token) {
            ...
            jwt.verify(token, 'secret_key', async (err, decoded) => {
                if (err) {
                    ...
                    "ELSE '/images/transparent.png' END as IconValitronics, d.Speed, Convert(nvarchar(10),DATEDIFF(MINUTE, isnull(d.DateDetencion, DATEADD(hh,2,getdate())), DATEADD(hh,2,getdate()))) as tiempodetencion "+
